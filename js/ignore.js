...
// 
function get_genre() {
    var genre_list = document.getElementsByClassName('genre-list');
    console.log(genre_list);
}

function call_api(book_genre) {
    var request = new XMLHttpRequest();
    ...
    var url = 'https://www.googleapis.com/books/v1/volumes?' + query + "&key=AIzaSyBJzLG1vPJaSlyl0bJ2xXI7uTz5Xx97jUE";

    if( book_genre == 'all' ) {
        query = "q=fiction"; // retrieve ALL heroes
    }
    else {
        // selected genre
        query = `q=romance`;
